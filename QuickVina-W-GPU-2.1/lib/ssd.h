...
/*
  ...
  print()����Ϊ��ʵ�ֶ�  evals��initial_factor ��min_factor��up ��downֵ�������
  ���ж����ĸ��������˳�ֵ�� evals=300��initial_factor=1e-4 ��min_factor=1e-6��up=1.6 ��down=0.5��
  operator��������ԭ�ͣ���ssh�л�ʹ�õ���
*/
...
evals��unsigned�� initial_factor��min_factor��up��down��double��
��ʼ����evals=300��initial_factor=1e-4��min_factor=1e-6��up=1.6��down=0.5��
���� operator()����ԭ�ͣ�
print�����������evals��initial_factor��min_factor��up��down��ֵ
