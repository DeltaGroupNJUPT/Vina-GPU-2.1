// -----------------------------------------------------------------------------
// PATCH: kernel2.h inlined manually (was: #include "kernel2.h")
// NVIDIA's OpenCL driver (596.36 and family) has a bug where #include directives
// in kernel source cause clBuildProgram to fail with CL_OUT_OF_HOST_MEMORY (-6)
// and zero log size. Inlining the include content is the documented workaround.
// Reference: NVIDIA Developer Forums thread on driver 595.97 #include bug.
// -----------------------------------------------------------------------------
